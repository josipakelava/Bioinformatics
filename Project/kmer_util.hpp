...
/**
 * Implementation of single sequence kmer sparsification.
 * @param seq all sequences
 * @param edge_kmer edge kmers generated by this method
 * @param s skipping length
 * @return sparsed set of kmers
 * @author Tea Povic
 */
...
/**
 * Represents kmer nodes in the graph created during the hitting set method.
 */
struct KmerNode {
    kmer_t kmer;
    int deg;
...
/**
 * Comparator for KmerNodes. KmerNodes with higher degrees come first.
 */
struct NodeCMP {
...
/**
 * Computes the graph of kmers for hitting set method.
 * @param s ordered set which is used to find nodes with highest degree
 * @param kmerToPtr kmer to node mapping
 * @param allPtrs all nodes created on heap, used to clean up the memory
 * @param m kmer to its neighbouring sets mapping
 * @author Ivan Krpelnik
 */
...
/**
 * Implementation of the hitting set method for kmer sparsification.
 * @param sequences all sequences
 * @param edge_kmer edge kmers generated by this method
 * @return sparsed set of kmers
 * @author Ivan Krpelnik
